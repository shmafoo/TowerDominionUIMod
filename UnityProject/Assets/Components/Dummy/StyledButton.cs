...
public class StyledButton : Button, IStyledSelectable
{
    ...
    private IEnumerator OnFinishSubmit() => null;

    public void OnValueChanged(bool isOn) { }

    public override Selectable FindSelectableOnUp() => null;

    public override Selectable FindSelectableOnDown() => null;
    
    public override Selectable FindSelectableOnRight() => null;
    
    public override Selectable FindSelectableOnLeft() => null;
    
    public void SetNavigation(IStyledSelectable up, IStyledSelectable down, IStyledSelectable right, IStyledSelectable left) { }
}
#endif